...
base_model_id_or_path = "/root/autodl-tmp/huggingface/models--deepseek-ai--DeepSeek-R1-0528-Qwen3-8B/snapshots/6e8885a6ff5c1dc5201574c8fd700323f23c25fa"

# 微调后保存的LoRA适配器权重和分词器的路径 (根据您的截图)
adapter_and_tokenizer_path = "/root/autodl-tmp/qwen/qwen2-8b-qlora-text-detection-full-test-2epoch-val-label/checkpoint-1400"

# 完整的、无标签的测试数据文件路径
predict_file_path = "/root/autodl-tmp/CCKs/data/test.jsonl"

# 预测结果输出目录和文件名
output_dir_predict = "/root/autodl-tmp/qwen/checkpoints-2epoch/checkpoints-1400" # 新的输出目录
